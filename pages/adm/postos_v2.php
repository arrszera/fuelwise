<?php 
    ...
    $sql = "SELECT * FROM posto ORDER BY nome ASC";
    ...
    <div id="modalAdicionarPosto" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <span onclick="fecharModalAdicionar()" class="close">&times;</span>
            </div>
            <form method="POST" action="posto_adicionar.php">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn secondary" onclick="fecharModalAdicionar()">Cancelar</button>
