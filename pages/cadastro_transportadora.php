  ...
  <div class="container">
    <div class="text-center">
      <div class="logo-circle">
        <svg fill="#2563eb" width="48" height="48" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <form class="form" method="POST" action="cadastro_transportadora_php.php">
        <div class="card-body">
          <div class="tabs">
            ...
            <button class="tab-btn" type="button" data-tab="pessoal">Informações Pessoais</button>
          </div>
          ...
          <div class="tab-content" id="empresa">
            ...
            <div class="form-group">
              ...
              <input placeholder="Nome da empresa" name="nomeEmpresa" value="<?= htmlspecialchars($_POST['nomeEmpresa'] ?? '') ?>" />
            ...
            <div class="form-row">
              <div class="form-group">
                <label>CEP</label>
                <input placeholder="01000-000" name="cep" value="<?= htmlspecialchars($_POST['cep'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
              <div class="form-group">
                <label>Cidade</label>
                <input placeholder="São Paulo" name="cidade" value="<?= htmlspecialchars($_POST['cidade'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
              <div class="form-group">
                <label>Estado</label>
                <input placeholder="SP" name="estado" value="<?= htmlspecialchars($_POST['estado'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                ...
                <input placeholder="(11) 98765-4321" name="telefoneEmpresa" value="<?= htmlspecialchars($_POST['telefoneEmpresa'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
              <div class="form-group">
                <label>CNPJ / Identificação Fiscal</label>
                <input placeholder="12.345.678/0001-99" name="cnpj" value="<?= htmlspecialchars($_POST['cnpj'] ?? '') ?>" />
          ...
          <div class="tab-content hidden" id="pessoal">
            ...
            <div class="form-row">
              <div class="form-group">
                <label>Nome</label>
                <input placeholder="João" name="nomePessoal" value="<?= htmlspecialchars($_POST['nomePessoal'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
              <div class="form-group">
                <label>Sobrenome</label>
                <input placeholder="Silva" name="sobrenome" value="<?= htmlspecialchars($_POST['sobrenome'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>CPF</label>
                <input type="text" placeholder="Ex: 123.456.789-12" name="cpf" value="<?= htmlspecialchars($_POST['cpf'] ?? '') ?>" />
                <p class="hint"></p>
              </div>
              <div class="form-group">
                <label>E-mail</label>
                <input type="email" placeholder="joao.silva@exemplo.com" name="email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" />
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input placeholder="(11) 98765-4321" name="telefonePessoal" value="<?= htmlspecialchars($_POST['telefonePessoal'] ?? '') ?>" />
                <p class="hint hidden"></p>
              </div>
            </div>
