		...
		<div class="col">
			...
			<?php
				...
				while($linha = $resultado->fetch_object()){
					$html = "<tr>";
					$html .= "<td>";
					$html .= "<a href='index.php?page=10&id=" . $linha->id_usuario . "' class='btn btn-danger'>Excluir</a> ";
					$html .= "<a href='index.php?page=11&id=" . $linha->id_usuario . "&nome=" . urlencode($linha->nome) . "' class='btn btn-success'>Alterar</a>";
					$html .= "</td>";
					$html .= "<td>" . $linha->id_usuario . "</td>";
					$html .= "<td>" . $linha->id_transportadora . "</td>";
